export const CaseIndexDictionary = {
  ...
  categoriaDadosPessoais: {
    ...
    financeiros: {
      idFin: { number: "7.2.1", title: "Dados de identificação financeira" },
      recursosFin: { number: "7.2.2", title: "Recursos financeiros" },
      dividasDespesas: { number: "7.2.3", title: "Dívidas e despesas" },
      solvencia: { number: "7.2.4", title: "Situação financeira (Solvência)" },
      emprestimosHipotecaCredito: {
        number: "7.2.5",
        title: "Empréstimos, hipotecas, linhas de crédito",
      },
      assistenciaFin: { number: "7.2.6", title: "Assistência financeira" },
      apoliceSeguro: {
        number: "7.2.7",
        title: "Detalhes da apólice de seguro",
      },
      planoPensao: { number: "7.2.8", title: "Detalhes do plano de pensão" },
    ...
    caracteristicas: {
      ...
      situacaoImigracao: { number: "7.3.3", title: "Situação de Imigração" },
    ...
    processoJudAdmCrim: {
      ...
      penalidadesAdm: { number: "7.9.4", title: "Penalidades Administrativas" },
    },
    habitosConsumo: {
      dadosBensServicos: {
        number: "7.10.1",
    ...
    regVideoImgVoz: {
      ...
      imagemVigilancia: { number: "7.14.2", title: "Imagem de Vigilância" },
  ...
  observacoesProcesso: { number: "16", title: "Observações sobre o Processo" },
};
