namespace CPTM.ILA.Web.Models.AccessControl
{
    ...
    public partial class ILA_VW_ESTRUTURA_ORG
    {
        ...
        [StringLength(100)]
        public string TX_NOME_REDUZIDO { get; set; }
        ...
        [StringLength(211)]
        public string TX_ENDERECO_COMPLETO { get; set; }
        ...
        [StringLength(10)]
        public string GER_SIGLA { get; set; }

        [StringLength(10)]
        public string GG_SIGLA { get; set; }

        [StringLength(10)]
        public string DIR_SIGLA { get; set; }

        [StringLength(10)]
        public string CD_TIPO_ESTRUTURA { get; set; }

        [StringLength(20)]
        public string TX_TIPO_ESTRUTURA { get; set; }
