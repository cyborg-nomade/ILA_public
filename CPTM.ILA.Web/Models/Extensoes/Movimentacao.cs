...
namespace CPTM.ILA.Web.Models
{
    ...
    {   
        ...
        public class Filtro : Movimentacao
        {
            [DisplayName("Tipo de Movimenta��o")]
            public decimal TipoMovimentacaoIds { get; set; }

            [DisplayName("Produto")]
            public short[] Ids { get; set; }

            [DisplayName("Data de Cadastro")]
            public short DataCadastroSelecionadas { get; set; }
        }
